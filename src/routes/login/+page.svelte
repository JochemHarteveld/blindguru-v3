...
<svelte:head><title>Sign in · PokerClock</title></svelte:head>
...
<div class="flex min-h-screen items-center justify-center bg-bg-base px-4">
	<div class="w-full max-w-sm">
		...
		<div class="mb-8 text-center">
			...
			<h1 class="mt-4 text-2xl font-black text-primary">Welcome back</h1>
			<p class="mt-1 text-sm text-secondary">Sign in to your account</p>
		</div>
		...
		<div class="rounded-2xl border border-border bg-bg-surface p-6 shadow-xl">
			...
			<form onsubmit={(e) => { e.preventDefault(); loginEmail(); }} class="flex flex-col gap-3">
				<div>
		...
		<p class="mt-4 text-center text-sm text-secondary">
			No account? <a href="/register" class="font-semibold text-accent-400 hover:text-accent-300">Create one free</a>
		</p>
	</div>
</div>
